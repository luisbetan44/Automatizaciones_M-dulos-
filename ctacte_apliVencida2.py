...
class cta_cte_apliVencidoV2(unittest.TestCase):
    def setUp(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cta_cte_apliVencidoV2)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteApliVencidoV2')
