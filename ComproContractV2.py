...
class comprobanteContratoV2(unittest.TestCase):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(comprobanteContratoV2)
  runner = xmlrunner.XMLTestRunner(output='reportComprobcontractoV2')
