...
import xmlrunner
import time
from Elements import  calendar_todate, click_icon_delete,displace_element,find_and_click_element_selector,  find_elements, find_send_element,generate_and_send_number,search_and_displace_account, select_option_click, validate_text, verify_and_click
...
class precio_granos_fijaciones(unittest.TestCase):
    ...
    def test_price_fixings(self):
       ...
       # seleccionar rango de fecha 02/12/2024 al 27/12/2024
        ...
        select_data_day = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-market-main/app-grain-price/div[2]/app-grain-price-table[3]/div/div/table/tbody/tr/td[7]/app-date-picker/div/input[2]"
        ...
        option_number_contract = "/html/body/ngb-modal-window/div/div/app-sales-intent-modal/div[2]/app-sales-intent-form/div/div[2]/div/div[2]/div/app-contract-searcher/ng-select/ng-dropdown-panel/div/div[2]/div/span"
