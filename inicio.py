    ...
    def test_login_user_1(self):
     ...
     # localiza el input y envia el número de la cuenta 
       ...
       ## validar si el texto es visible para el usuario 
        element = driver.find_element(By.XPATH, '//*[@id="layout-wrapper"]/div/div/div/app-home/app-balances/div[1]/div[1]/div')
       ...
       # Realizar validación del texto 
        ...
        if texto_optenido:
           print("El texto del saludo fue validado correctamente")
     ...
     ##validar totalizadores vencidos a hoy 
        ...
        elemento = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-balances/div[2]/swiper/div/div[1]/div[1]/app-number-values-card/div/div/div/div[3]/div/h4/span')
        valor_1 = elemento.text 
        if re.search(r'\d', valor_1):  
          print('El saldo vencido a hoy en ARS  es un carácter numérico.')
        else:
          print('El saldo vencido a hoy en ARS no es un carácter numérico.')
   
        elemento = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-balances/div[2]/swiper/div/div[1]/div[2]/app-number-values-card/div/div/div/div[3]/div/h4/span')
        valor_2 = elemento.text 
        if re.search(r'\d', valor_2):  
          print('El saldo vencido a hoy en USD  es un carácter numérico.')
        else:
          print('El saldo vencido a hoy en USD no es un carácter numérico.')

        ##validar totalizadores  a vencer  

        elemento = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-balances/div[2]/swiper/div/div[1]/div[3]/app-number-values-card/div/div/div/div[3]/div/h4/span')
        valor_3 = elemento.text 
        if re.search(r'\d', valor_3):  
          print('El saldo a vencer en ARS  es un carácter numérico.')
        else:
          print('El saldo a vencer en ARS no es un carácter numérico.')


        elemento = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-balances/div[2]/swiper/div/div[1]/div[4]/app-number-values-card/div/div/div/div[3]/div/h4/span')
        valor_4 = elemento.text 
        if re.search(r'\d', valor_4):  
          print('El saldo a vencer en USD  es un carácter numérico.')
        else:
          print('El saldo a vencer en USD no es un carácter numérico.')
         ## Seleccionar el elemento que contiene el texto 

        elemento = self.driver.find_element_by_xpath("//p[@class= 'fw-bold mb-0 t-gray-100 f-size-16 text-nowrap'] ")

        # Obtener el texto del elemento
        texto_obtenido = elemento.text
        
        # Validar el texto
        texto_esperado = "Resumen de mis negocios"
       ...
       ## entregado
        elemento_1 = driver.find_element(By.CSS_SELECTOR, 'div[class="fw-bold t-gray-200 f-size-14"]')
        valor_5 = elemento_1.text 
        if re.search(r'\d', valor_5):  
          print('El saldo entregado  es un carácter numérico.')
        else:
          print('El saldo entregado no es un carácter numérico.')
        ## fijado 
        elemento_2 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-business-indicators/div[2]/swiper[1]/div/div[1]/div[3]/app-indicator-card/div/div[2]/div[1]/div[2]')
        valor_6 = elemento_2.text 
        if re.search(r'\d', valor_6):  
          print('El saldo fijado es un carácter numérico.')
        else:
          print('El saldo fijado no es un carácter numérico.')
         ## pesificado
        elemento_3 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-business-indicators/div[2]/swiper[1]/div/div[1]/div[4]/app-indicator-card/div/div[2]/div[1]/div[2]')
        valor_7 = elemento_3.text 
        if re.search(r'\d', valor_7):  
          print('El saldo pesificado es un carácter numérico.')
        else:
          print('El saldo pesificado no es un carácter numérico.')

        ## liquidado
        elemento_4 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-business-indicators/div[2]/swiper[1]/div/div[1]/div[5]/app-indicator-card/div/div[2]/div[1]/div[2]')
        valor_8 = elemento_4.text 
        if re.search(r'\d', valor_8):  
          print('El saldo liquidado es un carácter numérico.')
        else:
          print('El saldo liquidado no es un carácter numérico.')
          ## pagado
        elemento_5 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-business-indicators/div[2]/swiper[1]/div/div[1]/div[6]/app-indicator-card/div/div[2]/div[1]/div[2]')
        valor_9 = elemento_5.text 
        if re.search(r'\d', valor_9):  
          print('El saldo pagado  es un carácter numérico.')
        else:
          print('El saldo pagado no es un carácter numérico.')

        # validar entregas recientes 

        elemento = self.driver.find_element_by_xpath('//*[@id="layout-wrapper"]/div/div/div/app-home/app-recent-grain-movements/div/div[1]/app-recent-deliveries/app-responsive-table-multiple-items/div/div/span[1] ')

        # Obtener el texto del elemento
        texto_obtenido = elemento.text
        
        # Validar el texto
        texto_esperado = "Entregas Recientes"
        self.assertEqual(texto_obtenido, texto_esperado)
        ...
        elemento_6 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-recent-grain-movements/div/div[1]/app-recent-deliveries/app-responsive-table-multiple-items/div/table/tbody/tr[1]/td[2]/div/div/span')
        valor_10 = elemento_6.text 
        if re.search(r'\d', valor_10):  
          print('El comprobante CTG  es un carácter numérico.')
        else:
          print('El comprobante CTG no es un carácter numérico.')

       # validar los Kilos netos 
        elemento_7 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-recent-grain-movements/div/div[1]/app-recent-deliveries/app-responsive-table-multiple-items/div/table/tbody/tr[1]/td[3]/div/div')
        valor_11 = elemento_7.text 
        if re.search(r'\d', valor_11):  
          print('Los kilos netos son  un carácter numérico.')
        else:
          print('Los kilos netos no es un carácter numérico.')
        
         # validar ventas recientes 

        elemento = self.driver.find_element_by_xpath(' /html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-recent-grain-movements/div/div[2]/app-recent-sales/app-responsive-table-multiple-items/div/div/span[1]')
        ...
        if re.search(r'\d', valor_12):  
          print('El saldo de kilos netos es un carácter numérico.')
        else:
          print('El saldo de kilos netos no es un carácter numérico.')

       # validar los Kilos netos 
        elemento_7 = driver.find_element(By.XPATH, '/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-home/app-recent-grain-movements/div/div[2]/app-recent-sales/app-responsive-table-multiple-items/div/table/tbody/tr[1]/td[3]/div/div')
        valor_13 = elemento_7.text 
        if re.search(r'\d', valor_13):  
          print('El precio es un carácter numérico.')
        else:
