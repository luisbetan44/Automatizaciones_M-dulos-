...
class comprobanteVentasV2(unittest.TestCase):
    ...
    def test_comprobante_ventasv2(self):
       ...
       # aplicar filtro con rango de fecha 29/12/2023 al 26/01/2024
        ...
        select_sales_filter1 = 'Ventas'
        find_elements_id(self.driver, select_sales_filter1)
        time.sleep(2)
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(comprobanteVentasV2)
  runner = xmlrunner.XMLTestRunner(output='reportcomprobanteVentasV2')
