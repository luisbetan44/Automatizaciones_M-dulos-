...
class detalle_ctro_entregaVentasV2(unittest.TestCase):
    ...
    def test_detail_deriverySales(self):
        ...
        select_filter = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-grains/div/div[4]/app-tab-contracts/app-contracts/app-header-for-responsive-table/div/div/div[2]/div/div[2]/app-filter-button/button/div"
