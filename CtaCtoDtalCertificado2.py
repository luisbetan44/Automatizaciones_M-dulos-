...
class detalle_cto_certificadosV2(unittest.TestCase):
    ...
    def test_detail_certificates(self):
        ...
        select_filter = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-grains/div/div[4]/app-tab-contracts/app-contracts/app-header-for-responsive-table/div/div/div[2]/div/div[2]/app-filter-button/button/div/span"
        ...
        select_campaign = "/html/body/ngb-offcanvas-panel/div/ngx-simplebar/div[1]/div[2]/div/div/div/app-filter-content/div[2]/app-season-container/div/app-season-button[4]/div/div"
        ...
        time.sleep(5)
         ...
         # Validar el texto
        element10 = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-grains/div/div[4]/app-tab-contracts/app-contracts/app-responsive-table-multiple-items/div/div/span"
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(detalle_cto_certificadosV2)
  runner = xmlrunner.XMLTestRunner(output='reportCuentaContratos2')
