...
from Elements import click_checkbox_xpaht,find_and_click_element_selector,find_elements, find_elements_id, find_elements_located, validate_chain_text_xpaht, validate_character_numeric_element, validate_text_by_text, validate_text_visible
...
class detalle_cto_liquidaciones(unittest.TestCase):
    ...
    def test_detail_liquidations(self):
       ...
       # Validar kilos pactados 
        ...
        element3 = "//span[text()='Listado de liquidaciones']"
        ...
        element4 = '//*[@id="settlements"]/app-contract-closeouts/app-responsive-table/div/div/table/thead/tr/th[2]'
        text_expected = "Fecha"
        ...
        element7 = '//*[@id="settlements"]/app-contract-closeouts/app-responsive-table/div/div/table/thead/tr/th[3]'
        ...
        element8 = '//*[@id="settlements"]/app-contract-closeouts/app-responsive-table/div/div/table/thead/tr/th[4]'
        ...
        element9 = '//*[@id="settlements"]/app-contract-closeouts/app-responsive-table/div/div/table/thead/tr/th[5]'
        ...
        element10 = '//*[@id="settlements"]/app-contract-closeouts/app-responsive-table/div/div/table/thead/tr/th[6]'
        ...
        download_button = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-detail-contract/app-contract-detail-tabs/div/div[4]/app-contract-closeouts/app-header-for-responsive-table/div/div/div[2]/div/div[1]/app-button/button/span"
        ...
        go_out_pag = "//a[text()='Mis Contratos']"
