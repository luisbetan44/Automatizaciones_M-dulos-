...
class cta_cte_pesiFechaComproV2(unittest.TestCase):
    def setUp(self):
    ...
    def test_ctacte_Date_expiration(self):
        ...
        select_tab_current_account = "current-account-pesified-tab"
        ...
        balance_ars = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-current-account/div/div/div/app-current-account-pesified-list/div/app-header-for-responsive-table/div/div/div[1]/div/div/app-totalizer/div/div/div[2]/div[2]/span[1]"
        ...
        movements_list_1 = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-current-account/div/div/div/app-current-account-pesified-list/div/app-responsive-table/div/div/table/tbody/tr[1]/th/input"
        find_elements(self.driver, movements_list_1)

        movements_list_2 =  "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-current-account/div/div/div/app-current-account-pesified-list/div/app-responsive-table/div/div/table/tbody/tr[2]/th/input"
        find_elements(self.driver, movements_list_2)

        movements_list_3 = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-current-account/div/div/div/app-current-account-pesified-list/div/app-responsive-table/div/div/table/tbody/tr[3]/th/input"
       ...
       ## seleccionar botón descargar  
        ...
        select_button = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-current-account/div/div/div/app-current-account-pesified-list/div/app-header-for-responsive-table/div/div/div[2]/div/div[1]/app-download-button/div/button[2]"
        ...
        detail_movements = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-current-account/div/div/div/app-current-account-pesified-list/div/app-responsive-table/div/div/table/tbody/tr[3]/td[2]/span/div"
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cta_cte_pesiFechaComproV2)
  runner = xmlrunner.XMLTestRunner(output='reportCtactepesiFechaComproV2')
