...
class entregas_Pend_FacturarV2(unittest.TestCase):
    ...
    def test_delivery_earrings(self):
        ...
        apply_state_filter = "Pendientes de Facturar"
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(entregas_Pend_FacturarV2)
  runner = xmlrunner.XMLTestRunner(output='reportentregas_Pend_FacturarV2')
