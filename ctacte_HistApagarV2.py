...
class cuenta_ctacte_histApagarV2(unittest.TestCase):
    def setUp(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cuenta_ctacte_histApagarV2)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteHistApagarV2')
