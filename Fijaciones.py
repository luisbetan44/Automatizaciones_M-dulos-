...
class Granos_test_tenant(unittest.TestCase):
    ...
    def test_login_user(self):
       ...
       #selecciona el elemento oculto y crea un botón para hacer click sobre el 
        ...
        select_button_pinup = driver.find_element_by_xpath("/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-bindings/div/div[1]/app-bindings-enabled-list/app-responsive-table-multiple-items/div/table/tbody/tr[1]/td[5]/div/div[2]/app-button/button")
        select_button_pinup.click()

        ## validar titulo de la pagima 


        title_pinup_grain = driver.find_element_by_xpath("/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-set-price/div[1]/div[1]/section/form/div/h2")
        ...
        insert_price_grain = driver.find_element_by_xpath("/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-set-price/div[1]/div[1]/section/form/div/div/div[12]/div/div/input")
