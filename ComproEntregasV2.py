...
import xmlrunner
import time
from Elements import  find_and_click_element, find_elements, find_elements_id,validate_text
...
class comprobanteEntregasV2(unittest.TestCase):
    ...
    def test_comprobante_entregasv2(self):
       ...
       # aplicar filtro con rango de fecha 29/12/2023 al 26/01/2024
        ...
        select_deliveries_filter1 = 'Entregas'
        find_elements_id(self.driver, select_deliveries_filter1)
        time.sleep(2)
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(comprobanteEntregasV2)
  runner = xmlrunner.XMLTestRunner(output='reportcomprobanteEntregasV2')
