...
class entregas_AplicadasV2(unittest.TestCase):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(entregas_AplicadasV2)
  runner = xmlrunner.XMLTestRunner(output='reportEntregasAplicarV2')
